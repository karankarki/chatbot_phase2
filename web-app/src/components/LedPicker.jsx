...
const OLD_LEDS = [
  ...
  { animData: whiteFlash,  label: 'White',  sub: 'Flashing', message: 'White, flashing' },
...
const NEW_LEDS = [
  ...
  { animData: greenFlashSolid, label: 'Green',  sub: '3× Flash → Solid',   message: 'Green, 3 flashes then solid' },
  { animData: purpleSlowBlink, label: 'Purple', sub: 'Slow Blinking',      message: 'Purple, slow blinking' },
  { animData: amberFlash,      label: 'Amber',  sub: '3× Rapid Flash',     message: 'Amber, 3x rapid flashing' },
