...
const OLD_LEDS = [
  ...
  { animData: redBlink,    label: 'Red',    sub: 'Fast blink (~500ms)', message: 'Red, fast blinking (~500ms)' },
  { animData: redBlink,    label: 'Red',    sub: 'Blink (~1s)',        message: 'Red, blinking (~1s)' },
  { animData: redBlink,    label: 'Red',    sub: 'Slow blink (~2s)',   message: 'Red, slow blinking (~2s)' },
